...
namespace OnlineKredit.logic
{
    ...
    public partial class dbOnlineKreditLAPEntities1 : DbContext
    {
        public dbOnlineKreditLAPEntities1()
            : base("name=dbOnlineKreditLAPEntities1")
        {
        }
        ...
        public DbSet<Einstellung> AlleEinstellungen { get; set; }
        public DbSet<FamilienStandAngabe> AlleFamilienStandAngaben { get; set; }
